...
class OrderOutController extends CrudController
{
    ...
    {
        $this->arrayData['equipments'] = $this->equipment->showStock();
        $this->arrayData['technicals'] = $this->technical->all();
    ...
    public function assignEquipment(Request $request)
    {
        ...
        return redirect()->route($this->groupRoute.'.show', $request->order_out_id);
    }
