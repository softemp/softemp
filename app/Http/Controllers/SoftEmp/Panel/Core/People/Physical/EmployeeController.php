    ...
    public function store(Request $request)
    {
        try {
            ...
            if (is_object($people)) {
                ...
                $request['person_id'] = $people->id;
            }

            $this->redirect = 'edit'; // Alterando a rota de retorno padrãp para a rota edit

            $result = parent::store($request); // TODO: Change the autogenerated stub
...
//        }catch(\Exception $e){
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $personPhysical->occupations()->sync($request->occupation_id);
            ...
            $result = parent::update($request, $id); // TODO: Change the autogenerated stub
            DB::commit(); //validar as transações
