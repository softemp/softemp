                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-default btn-xs"
                                onclick="showColumns('{{ route('panel.provedor.mkauth.table.show',['table'=>$table]) }}');">
                            <i class="fa fa-eye"></i>
                        </button>
                    </td>
                </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        <label>Colunas </label> <span id="columns"></span>
                    </div>
                </div>
        ...
        function showColumns(url) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var text, fLen, i;
                    fLen = data.columns.length;

                    text = "<ul>";
                    for (i = 0; i < fLen; i++) {
                        text += "<li>" + data.columns[i] + "</li>";
                    }
                    text += "</ul>";

                    $('#modal-show-columns #columns').html(text);
                },
                error: function (msg) {
                    console.log(msg);
                }
