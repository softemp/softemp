        ...
        <div class="row">
            ...
            <div class="panel-body social col-sm-offset-3">
                ...
                <div class="clearfix">
                    ...
                    <div class="col-xs-12 col-sm-6 col-sm-offset-2">
                        <form class="omb_loginForm" autocomplete="off" method="POST" action="{{ route('auth.login') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="input-group{{ $errors->has('user_name') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" name="user_name" placeholder="Seu Login"
                            ...
                            <button type="submit" class="btn btn-md btn-primary btn-block submit">Logar</button>
...
@section('footer_scripts')
    <script type="text/javascript">
        $('.forgot').click(function () {
            window.location.href = "{{ route('auth.password.forgot.form') }}";
            return false;
        });
    </script>
@stop
