    ...
    <div class="row">
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                ...
                <a href="{{ route('panel.people.company.index') }}" class="small-box-footer">Listar <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        {{--<!-- ./col --}}
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-green">
                ...
                <a href="{{ route('panel.people.physical.index') }}" class="small-box-footer">Mais Informações <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        {{-- ./col --}}
        <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Listar Pessoa Física</h3>
                    <div class="pull-right">
{{--                        @can('user-store')--}}
                            <a class="btn btn-primary btn-xs"
                               href="{{ route('panel.people.create') }}">Novo</a>
{{--                        @endcan--}}
                    </div>
                </div>
...
{{--                                @can('user-update','user-destroy')--}}
                                    <td>
{{--                                        @can('user-update')--}}
                                            <a href="{{ route('panel.people.edit',['id'=>$person->id]) }}"
...
{{--                                        @can('user-destroy')--}}
                                            <a href="#"
                                               onclick="destroy('{{route('panel.people.destroy',['id'=>$person->id])}}');"
