                ...
                <div class="box-header">
                    ...
                    <div class="pull-right">
                        ...
                        <a class="btn btn-primary btn-xs"
                           href="{{ route('panel.people.employee.create') }}">Novo</a>
                        {{--@endcan--}}
                        {{--@can('user-store')--}}
{{--                            <a class="btn btn-danger btn-xs"--}}
{{--                               href="{{ route('panel.people.employee.create') }}">Lixeira</a>--}}
                        {{--@endcan--}}
                    </div>
                </div>

                <div class="btn-group" role="group" aria-label="...">
                    <a class="btn btn-default btn-sm" href="{{ route('panel.people.employee.index') }}" role="button">Pessoas Ativos</a>
                    <a class="btn btn-success btn-sm" href="{{ route('panel.people.employee.index') }}?withTrashed=true" role="button">Ativas e deletadas</a>
                    <a class="btn btn-danger btn-sm" href="{{ route('panel.people.employee.index') }}?onlyTrashed=true">Somente as Deletadas</a>
                </div>
                ...
                <div class="box-body">
                    <table id="table1" class="display responsive nowrap dataTable no-footer dtr-inline collapsed"
                        ...
                        @foreach($data as $people)
                            <tr>
                                <td>{{ $people->physical->name }}</td>
                                {{--@can('user-update','user-destroy')--}}
                                <td>
                                    @if(!$people->trashed())
                                    {{--@can('user-update')--}}
                                    <a href="{{ route('panel.people.employee.edit',['id'=>$people->physical->id]) }}"
                                    ...
                                    {{--@can('user-destroy')--}}
                                    <a href="#"
                                       onclick="destroy('{{route('panel.people.employee.destroy',['id'=>$people->id])}}');"
                                    ...
                                    {{--@endcan--}}
                                    @else
                                        <a href="{{ route('panel.people.employee.restore', ['person_id'=>$people->id]) }}"><i class="fa fa-fw fa-undo text-danger"></i></a>
                                    @endif
                                </td>
                                {{--@endcan--}}
                            </tr>
