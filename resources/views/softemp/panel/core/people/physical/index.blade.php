...
{{--                        @can('user-store')--}}
                            <a class="btn btn-primary btn-xs"
                               href="{{ route('panel.people.physical.create') }}">Novo</a>
{{--                        @endcan--}}
                    </div>
                </div>
...
{{--                            @endcan--}}
                        ...
                        <tbody>
                        @foreach($data as $physical)
                            <tr>
                                <td>{{ $physical->name }}</td>
{{--                                @can('user-update','user-destroy')--}}
                                    <td>
{{--                                        @can('user-update')--}}
                                            <a href="{{ route('panel.people.physical.edit',['id'=>$physical->id]) }}"
...
{{--                                        @can('user-destroy')--}}
                                            <a href="#"
                                               onclick="destroy('{{route('panel.people.physical.destroy',['id'=>$physical->id])}}');"
