                ...
                <div class="box-header">
                    ...
                    <div class="pull-right">
                        ...
                        <a class="btn btn-primary btn-xs"
                           href="{{ route('panel.people.client.create') }}">Novo</a>
                        {{--                        @endcan--}}
                    </div>
                </div>
                    ...
                    <table id="table1" class="display responsive nowrap dataTable no-footer dtr-inline collapsed" style="width: 100%;" role="grid">
                        ...
                        @foreach($data as $person)
                            ...
                            <tr>
                                ...
                                <td>
                                    {{--                                        @can('user-update')--}}
                                    <a href="{{ route('panel.people.client.edit',['id'=>$person->id]) }}"
                                    ...
                                    {{--                                        @can('user-destroy')--}}
                                    <a href="#"
                                       onclick="destroy('{{route('panel.people.client.destroy',['id'=>$person->id])}}');"
