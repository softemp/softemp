        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Listar Permissões</h3>
                    <div class="pull-right">
                        {{--@can('role-store')--}}
                            <a class="btn btn-primary btn-xs"
                               href="{{ route('panel.access.control.permission.create') }}">Novo</a>
                        {{--@endcan--}}
                    </div>
                </div>
                    ...
                    <table id="table1" class="display responsive nowrap dataTable no-footer dtr-inline collapsed"
                        ...
                        @foreach($data as $permission)
                            <tr>
                                ...
                                <td>
                                    {{--@can('role-update')--}}
                                    <a href="{{ route('panel.access.control.permission.edit',['id'=>$permission->id]) }}"
                                       title="Alterar" class="btn btn-xs btn-warning">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    {{--@endcan--}}
                                        {{--@can('role-view-permissions')--}}
                                        {{--<a href="{{ route('panel.access.control.permission.permissions.edit',['role_id'=>$permission->id]) }}"--}}
                                        ...
                                        {{--@can('role-destroy')--}}
                                        <a href="#"
                                           onclick="destroy('{{route('panel.access.control.permission.destroy',['id'=>$permission->id])}}','{{$permission->name}}');"
