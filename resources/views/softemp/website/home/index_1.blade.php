...
{{-- page level styles --}}
@section('styles_css')
    <link rel="stylesheet" type="text/css" href="{{ asset('softemp/vendors/owl.carousel/css/owl.carousel.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('softemp/vendors/owl.carousel/css/owl.theme.default.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('softemp/vendors/ihover/ihover.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('softemp/vendors/animate/animate.min.css') }}"/>
    <style>
...
@section('content')
    ...
    <div id="owl-demo" class="owl-carousel owl-theme">
        <div class="item">
            <img src="{{ asset('softemp/images/banner_index/b1.png') }}" alt="slider-image" class="img-fluid">
            <div class="item-caption">
                <h3 class="title"> rtn yryrt ytr ybtry tryr </h3>
            </div>
        </div>
        <div class="item">
            <img src="{{ asset('softemp/images/banner_index/b2.png') }}" alt="slider-image" class="img-fluid">
            <div class="item-caption">
                <h2 class="subtitle"> Teste ddddddddd234 5234 5 25 23dddde </h2>
            </div>
        </div>
        <div class="item">
            <img src="{{ asset('softemp/images/banner_index/b3.png') }}" alt="slider-image" class="img-fluid">
        ...
        <div class="item">
            <img src="{{ asset('softemp/images/banner_index/b4.png') }}" alt="slider-image" class="img-fluid">
        </div>
        <div class="item">
            <img src="{{ asset('softemp/images/banner_index/b5.png') }}" alt="slider-image" class="img-fluid">
        </div>
    </div>
            ...
            <div class="row rcnt-wrk">
                    ...
                    <div class="ih-item square colored effect13 left_to_right">
                        <a href="#">
                            <div class="img wow bounceInLeft" data-wow-duration="3s"><img
                                        src="{{ asset('softemp/images/recent_works/1.jpg') }}" class="img-fluid"></div>
                            <div class="info">
                    ...
                    <div class="ih-item square colored effect13 left_to_right">
                        <a href="#">
                            <div class=" wow bounceInRight" data-wow-duration="3s" data-wow-delay="1.2s"><img
                                        src="{{ asset('softemp/images/recent_works/2.jpg') }}" class="img-fluid"></div>
                            <div class="info">
                    ...
                    <div class="ih-item square colored effect13 left_to_right">
                        <a href="#">
                            <div class=" wow bounceInLeft" data-wow-duration="3s" data-wow-delay="1.2s"><img
                                        src="{{ asset('softemp/images/recent_works/3.jpg') }}" class="img-fluid"></div>
                            <div class="info">
                ...
                <div class="col-12 col-md-6 col-sm-12 col-lg-3 column-padding-remove">
                    <div class="ih-item square colored effect13 left_to_right">
                        <a href="#">
                            <div class="wow bounceInRight" data-wow-duration="3s" data-wow-delay="1.2s"><img
                                        src="{{ asset('softemp/images/recent_works/4.jpg') }}" class="img-fluid"></div>
                            <div class="info">
            ...
            <div class="row rcnt-wrk">
                <div class="col-12 col-md-6 col-sm-12 col-lg-3 column-padding-remove">
                    <div class="ih-item square colored effect13 right_to_left">
                        <a href="#">
                            <div class=" wow  bounceInLeft" data-wow-duration="3s" data-wow-delay="1.2s"><img
                                        src="{{ asset('softemp/images/recent_works/5.jpg') }}" class="img-fluid"></div>
                            <div class="info">
                ...
                <div class="col-12 col-md-6 col-sm-12 col-lg-3 column-padding-remove">
                    <div class="ih-item square colored effect13 right_to_left">
                        <a href="#">
                            <div class=" wow  bounceInRight" data-wow-duration="3s" data-wow-delay="1.2s"><img
                                        src="{{ asset('softemp/images/recent_works/6.jpg') }}" class="img-fluid"></div>
                            <div class="info">
                ...
                <div class="col-12 col-md-6 col-sm-12 col-lg-3 column-padding-remove">
                    <div class="ih-item square colored effect13 right_to_left">
                        <a href="#">
                            <div class=" wow  bounceInLeft" data-wow-duration="3s" data-wow-delay="1.2s"><img
                                        src="{{ asset('softemp/images/recent_works/7.jpg') }}" class="img-fluid"></div>
                            <div class="info">
                ...
                <div class="col-12 col-md-6 col-sm-12 col-lg-3 column-padding-remove">
                    <div class="ih-item square colored effect13 right_to_left">
                        <a href="#">
                            <div class="wow  bounceInRight" data-wow-duration="3s" data-wow-delay="1.2s"><img
                                        src="{{ asset('softemp/images/recent_works/8.jpg') }}" class="img-fluid"></div>
                            <div class="info">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 wow bounceInLeft" data-wow-duration="5s">
                            <div id="devices" data-position="left" class="notViewed animBlock">
                                <div class="c1_image">
                                    <img src="{{ asset('softemp/images/c1.png') }}" class="img-fluid">
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6  col-sm-6 col-lg-3 wow slideInUp" data-wow-duration="1s">
                        <div data-position="left" data-offset="100" class="notViewed animBlock">
                            <img src="{{ asset('softemp/images/profile1.jpg') }}" class="img-fluid">
                            <h4><b>Lina Doe</b></h4>
                    ...
                    <div class="col-12 col-md-6  col-sm-6 col-lg-3 wow zoomIn" data-wow-duration="1s">
                        <div data-position="right" data-offset="50" class="notViewed animBlock">
                            <img src="{{ asset('softemp/images/profile2.jpg') }}" class="img-fluid">
                    ...
                    <div class="col-12 col-md-6  col-sm-6 col-lg-3 wow zoomIn" data-wow-duration="1s">
                        <div data-position="left" data-offset="50" class="notViewed animBlock">
                            <img src="{{ asset('softemp/images/profile3.jpg') }}" class="img-fluid">
                    ...
                    <div class="col-12 col-md-6  col-sm-6 col-lg-3 wow slideInUp" data-wow-duration="1s">
                        <div data-position="right" data-offset="100" class="notViewed animBlock">
                            <img src="{{ asset('softemp/images/profile4.jpg') }}" class="img-fluid">
            ...
            <div class="col-sm-6 wow rollIn" data-wow-duration="3s">
                ...
                <div class="media testimonal-media">
                    <div class="media-left">
                        <a href="#">
                            <img class="media-object" src="{{ asset('softemp/images/d2.jpg') }}" alt="image"
            ...
            <div class="col-sm-6 wow rollIn" data-wow-duration="3s">
                ...
                <div class="media testimonal-media" dir="rtl">
                    <div class="media-right">
                        <a href="#">
                            <img class="media-object profile-right-img" src="{{ asset('softemp/images/d1.jpg') }}"
...
{{-- page level scripts --}}
@section('scripts_js')
    <script src="{{ asset('softemp/vendors/owl.carousel/js/owl.carousel.js') }}" type="text/javascript"></script>
    <script src="{{ asset('softemp/vendors/wow/js/wow.min.js') }}" type="text/javascript"></script>
